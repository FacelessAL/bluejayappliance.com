...
export default function TopBar() {
  ...
  return (
    <>
      {/* Blue utility bar — Facebook + phone (desktop only) */}
      ...
      <div style={{ backgroundColor: '#ffffff' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          {/* Mobile: hamburger lives in Navbar component */}
          {/* Desktop: Navbar component renders here via layout */}
        </div>
      </div>
    </>
  );
